...
import org.familysearch.products.gallery.application.pageobject.landingpage.HeaderSection;
...
import org.familysearch.products.gallery.test.web.landingpage.SignInTest;
import org.familysearch.products.gallery.testframework.selenium.JQuery;
import org.familysearch.products.gallery.testframework.selenium.productsGallerySeleniumTestBase;

public class GalleryTestBase extends productsGallerySeleniumTestBase {
	
	private static final Logger logger = org.apache.log4j.Logger.getLogger( GalleryTestBase.class );
public static String DEFAULT_START_URL = "https://familysearch.org/products/";

public GalleryTestBase(String testBrowserName, String testBrowserVersion, String testBrowserOs) {
